...
# app/prompts/templates/judge.md (GUIDE-003 T1-1 + T2-1) and is the SINGLE
# source of truth — templates/README.md rule 1 forbids inline copies (an
# earlier inline duplicate here silently shadowed template edits; FEAT-029).
